 ...
 *  Intended for internal use from within Prolog4J.
 */
class Terms {
    ...
    public static Int toTerm(Integer i) {
        return new Int(i);
    }

    public static Integer toInteger(Term t) {
        return ((Int) t).intValue();
    }

    public static Term toTerm(Long l) {
    ...
    public static Term toTerm(Float f) {
        return new alice.tuprolog.Float(f);
    }

    public static Float toFloat(Term t) {
        return ((alice.tuprolog.Float) t).floatValue();
    }

    public static Term toTerm(Double d) {
    ...
    public static Term toTerm(String s) {
